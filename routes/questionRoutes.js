...
const { createQuestionAndAnswer, getAllQuestion, deleteQuestion, updateQuestion, getQuestionById, getAllQuestionByCategoryandDifficultyLevel} = require('../controllers/questionController');
